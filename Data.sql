...
CREATE TABLE users (id INTEGER PRIMARY KEY AUTOINCREMENT, first_name TEXT NOT NULL, last_name TEXT NOT NULL, motto TEXT);
CREATE TABLE dogs ( id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL);
CREATE TABLE favorites (id INTEGER PRIMARY KEY AUTOINCREMENT, user_id INTEGER, dog_id INTEGER, FOREIGN KEY(user_id) REFERENCES users(id), FOREIGN KEY(dog_id) REFERENCES dogs(id));
...
INSERT INTO dogs (name) VALUES ('Jeffery');
